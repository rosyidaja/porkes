        ...
        <div class="row">
          <div class="banner-info">
            ...
            <div class="iframe-container">
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31657.504880396624!2d112.74402188814592!3d-7.332759418138233!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x447eceaea21cd258!2sRS+Royal+Surabaya!5e0!3m2!1sid!2sid!4v1536358196134" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
            </div>
            <!-- end maps -->

          </div>
          <div class="overlay-detail text-center">
            <a href="#service"><i class="fa fa-angle-down" style="bottom: 100px;"></i></a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-3 col-sm-3 col-xs-6">
          <div class="thumbnail">
            <img src="<?php echo base_url('assets/img/doctor1.jpg');?>" alt="..." class="team-img">
            <div class="caption">
              <h3>Jessica Wally</h3>
              <p>Doctor</p>
        ...
        <div class="col-md-3 col-sm-3 col-xs-6">
          <div class="thumbnail">
            <img src="<?php echo base_url('assets/img/doctor2.jpg');?>" alt="..." class="team-img">
            <div class="caption">
              <h3>Iai Donas</h3>
              <p>Doctor</p>
              <ul class="list-inline">
        ...
        <div class="col-md-3 col-sm-3 col-xs-6">
          <div class="thumbnail">
            <img src="<?php echo base_url('assets/img/doctor3.jpg');?>" alt="..." class="team-img">
            <div class="caption">
              <h3>Amanda Denyl</h3>
              <p>Doctor</p>
              <ul class="list-inline">
        ...
        <div class="col-md-3 col-sm-3 col-xs-6">
          <div class="thumbnail">
            <img src="<?php echo base_url('assets/img/doctor4.jpg');?>" alt="..." class="team-img">
            <div class="caption">
              <h3>Jason Davis</h3>
              <p>Doctor</p>
              <ul class="list-inline">
