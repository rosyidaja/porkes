          ...
          <div class="box">
            ...
            <form role="form">
              <div class="box-body">
                ...
                <div class="form-group" style="width: 400px">
                  ...
                  <input type="text" class="form-control" placeholder=" Alamat Faskes ...">
                </div>
                <div class="form-group" style="width: 400px">
                  <label for="exampleInputEmail1">Poli</label>
                  <input type="text" class="form-control" placeholder=" Poli ...">
                </div>
                <div class="form-group" style="width: 400px">
            ...
            <!-- /.box-header -->
                ...
                <div class="form-group">
                  <label>Status</label>
                    <select class="form-control select2" style="width: 110px;">
